  ...
  return (
    <div className='mt-8'>
        ...
        <form onSubmit={handleSubmit} className='flex flex-col justify-center items-center my-12'>
                ...
                <button type='submit' disabled={loading} className='border-2 border-gray-500 mt-8 text-gray-600 font-semibold rounded-lg px-12 py-2 inline-block hover:bg-gray-500 hover:text-white hover:cursor-pointer'>Add item</button>
